...
def each_fit(tmin, gamma, mass, mom, ll, b, z):
    ...
    gs_fit = Gs_Fit(
        two_state_fit(),
        fit_id="{}{}_P{}_L{}_b{}_z{}_tmax9_cut0".format(mass, gamma, mom, ll, b, z),
    )
...
tmin_stability_plot(
    ...
    p_value_ls,
    logGBF_ls,
    "{}{}_P{}_L{}_b{}_z{}_real".format(mass, gamma, mom, ll, b, z),
    chose_idx=0,
    save=True,
)
...
tmin_stability_plot(
    ...
    p_value_ls,
    logGBF_ls,
    "{}{}_P{}_L{}_b{}_z{}_imag".format(mass, gamma, mom, ll, b, z),
    chose_idx=0,
    save=True,
)
